...
export function Flashcard({ card }: FlashcardProps) {
  ...
  return (
    <div 
      className="perspective-1000 w-full px-4"
    ...
    >
      ...
      >
        ...
        >
          <div className="text-[120px] leading-none mb-6">{card.front}</div>
        ...
        >
          <div className="text-4xl mb-3 text-center leading-tight">{card.back}</div>
          {card.romaji && (
